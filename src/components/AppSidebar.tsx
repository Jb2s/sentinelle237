import {
  Sun, Clock3, Bookmark, PenLine,
  Plus, Search, Moon, Wrench, HelpCircle,
  Settings, Rss, Menu, X, Home,
} from "lucide-react";
      ...
      {isMobile && (
        <header className="fixed top-0 left-0 right-0 z-50 h-14 border-b border-border bg-background/95 backdrop-blur flex items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-lg">Sentinelle 237</span>
        ...
        <div className="fixed inset-0 z-[60]">
          ...
          <aside className="absolute left-0 top-0 h-full w-72 bg-sidebar border-r border-sidebar-border flex flex-col">
            <div className="flex items-center justify-between p-5 border-b border-sidebar-border">
              <div>
                <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                <h1 className="font-display font-bold text-xl mt-1">Sentinelle 237</h1>
                <div className="flex items-center ml-1">
                  <div className="h-0.5 w-[12px] bg-[#007A5E]" />
                  <div className="h-0.5 w-[12px] bg-[#CE1126]" />
                  <div className="h-0.5 w-[12px] bg-[#FCD116]" />
            ...
            <div className="px-3 py-4 border-t border-sidebar-border mt-2 space-y-1">
            ...
            <div className="px-5 pt-3 pb-2 flex items-center justify-between">
              <span className="text-[11px] font-bold tracking-widest text-muted-foreground uppercase">Flux</span>
      ...
      {!isMobile && (
        <div className="flex h-screen sticky top-0">
          ...
          <aside className="w-14 bg-gradient-primary flex flex-col items-center py-4 gap-5 text-primary-foreground">
            <button
              onClick={() => navigate("/")}
              className="w-9 h-9 rounded-xl bg-primary-foreground/15 backdrop-blur flex items-center justify-center hover:bg-primary-foreground/25 transition-smooth"
            >
            ...
            <div className="mt-auto flex flex-col items-center gap-3">
              ...
              <button
                ...
                title={user?.email}
                className="w-9 h-9 rounded-full bg-primary-glow border-2 border-primary-foreground/40 flex items-center justify-center font-bold text-white cursor-pointer hover:opacity-90 transition-smooth"
              >
          ...
          <aside className="w-72 bg-sidebar border-r border-sidebar-border flex flex-col overflow-hidden">
            <div className="p-5 border-b border-sidebar-border">
              ...
              <div className="flex items-center ml-5">
                <div className="h-0.5 w-[12px] bg-[#007A5E]" />
                <div className="h-0.5 w-[12px] bg-[#CE1126]" />
                <div className="h-0.5 w-[14px] bg-[#FCD116]" />
              </div>
            </div>
